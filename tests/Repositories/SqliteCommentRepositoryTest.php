...
class SqliteCommentRepositoryTest extends TestCase
{
    ...
    public function testItFindsCommentByPostId(): void
    {
        $postId = UUID::random();
        ...
        $found = $this->repository->getByPostId($postId);

        $this->assertSame((string)$comment->getId(), (string)$found->getId());
        $this->assertSame((string)$postId, (string)$found->getPostId());
        $this->assertSame($comment->getText(), $found->getText());
    }

    public function testItThrowsExceptionIfCommentByPostIdNotFound(): void
    {
        $this->expectException(CommentNotFoundException::class);

        $this->repository->getByPostId(UUID::random());
    }

    public function testItFindsCommentByAuthorId(): void
    {
    ...
    public function testItThrowsExceptionIfCommentByAuthorIdNotFound(): void
    {
        $this->expectException(CommentNotFoundException::class);
